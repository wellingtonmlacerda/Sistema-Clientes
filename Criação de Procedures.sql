--LISTA OS CLIENTES
CREATE PROCEDURE CLIENTE_LISTA  
	@ID INT = NULL  
AS  
BEGIN  
	SELECT CLIE.CLIE_PK_ID, CLIE.CLIE_CPF, CLIE.CLIE_NOME, CLIE.CLIE_NASCIMENTO, CLIE.CLIE_SEXO
	, TICL.TICL_TIPO, CLIE.CLIE_FK_PK_TICL, TICL.TICL_DESCRICAO, CLIE.CLIE_FK_PK_SICL, SICL.SICL_DESCRICAO
	FROM DBO.CLIENTES CLIE
		INNER JOIN DBO.TIPO_CLIENTES TICL  
			ON CLIE.CLIE_FK_PK_TICL = TICL.TICL_PK_ID  
		INNER JOIN DBO.SITUACAO_CLIENTES SICL
...
CREATE PROCEDURE LISTA_SITUACAO_CLIENTES  
	@ID INT = NULL  
AS  
BEGIN 
	SELECT *
